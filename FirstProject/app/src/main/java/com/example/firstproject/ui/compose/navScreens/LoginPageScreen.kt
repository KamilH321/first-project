    ...
    LoginContent(
        ...
        onSignUpClick = {
            validate(
                email,
                password,
                resManager.getString(R.string.error_email_is_blank),
                resManager.getString(R.string.error_password_is_blank),
                resManager.getString(R.string.error_email_not_valid),
                resManager.getString(R.string.error_password_length),
                ...
                coroutineScope.launch {
                    ...
                    if (user != null && BCrypt.checkpw(password, user.password)) {
                        ...
                        commonError = resManager.getString(R.string.error_invalid_credentials)
                    }
                }
            }
        },
